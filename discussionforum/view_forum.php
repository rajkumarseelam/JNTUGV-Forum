	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<button class="upvote" data-post-id="1" onclick="upvote(<?php echo $id ?>)"> <i class="ri-thumb-up-fill"></i></button>
				<button class="downvote" data-post-id="1" onclick="downvote(<?php echo $id ?>)"><i class="ri-thumb-down-fill"></i></button>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
...
<script>
	...
	function upvote($post_id){
        ...
        $.ajax({
            ...
            method:'POST',
            data:{id:$post_id,vote_type:1},
            success:function(resp){
                if(resp==1){
                    alert_toast("liked",'success')
                    setTimeout(function(){
                        location.reload()
                    },1500)
	...
	function downvote($post_id){
        ...
        $.ajax({
            url:'ajax.php?action=vote',
            method:'POST',
            data:{id:$post_id,vote_type:0},
            success:function(resp){
                if(resp==1){
                    alert_toast("Disliked",'success')
                    setTimeout(function(){
                        location.reload()
                    },1500)
