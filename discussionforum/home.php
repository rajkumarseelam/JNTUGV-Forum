...
.imgs{
    ...
    .card-bg{
        background-color:#555f79!important;
    }
    .text-primary {
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-primary card-bg">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-info card-bg">
                                    <div class="card-body text-white">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-warning card-bg">
                                    <div class="card-body text-white">
                    ...
                    <div class="row">
                    <?php
                     $tags = $conn->query("SELECT * FROM categories order by name asc limit 10");
